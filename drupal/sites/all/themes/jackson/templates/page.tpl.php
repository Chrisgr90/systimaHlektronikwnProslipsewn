  ...
  <div id="page-wrapper">
    <div id="page">
      ...
      <div id="header"><div class="container section header clearfix">
        ...
        <?php if ($logo): ?>
          <a href="<?php print $front_page; ?>" title="<?php print t(''); ?>" rel="home" id="logo" class="logo">
            <img src="<?php print $logo; ?>" alt="<?php print t(''); ?>" />
          </a>
        <?php endif; ?>
        <div id="log-in-out">
        <?php if(!$logged_in) print l('Σύνδεση |', 'user/login'); ?>
		<?php if(!$logged_in) print l('Εγγραφή', 'user/register'); ?>
